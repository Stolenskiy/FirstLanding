        ...
        var i = !1, s = {
            TRANSITION_END: "bsTransitionEnd", getUID: function (t) {
                ...
                n && "#" !== n || (n = e.getAttribute("href") || ""), "#" === n.charAt(0) && (n = function (e) {
                    return e = "function" == typeof t.escapeSelector ? t.escapeSelector(e).substr(1) : e.replace(/(:|\.|\[|\]|,|=|@)/g, "\\$2")
                }(n));
                try {
            ...
            T = "carousel-item-next", y = "carousel-item-prev", C = {
                ...
                return I.next = function () {
                    ...
                    if (i) {
                        var s = t(i)[0];
                        if (s && t(s).hasClass(g)) {
                            var l = r({}, t(s).data(), t(this).data()), h = this.getAttribute("dir");
